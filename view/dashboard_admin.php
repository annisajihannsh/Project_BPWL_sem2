<?php
include '../model/database_home.php';
$db = new database();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="assets/img/logo/logo.png" rel="logo">
                                                            ...
                                                            <?php foreach ($db->tampil_barang() as $d) { ?>
                                                                <div class="panel panel-primary">
                                                                    ...
                                                                    <div class="panel-footer">
                                                                        <center>
                                                                            <h4 style="font-size:15px;font-weight:700;"><a href='tampil_barang.php'>Tabel Barang <i class='fa fa-angle-double-right'></i></a></h4>
                                                                        </center>
                                                                    </div>
                                                                </div>
                                                            <?php
                                                        ...
                                                        <table>
                                                            <?php foreach ($db->tampil_jual() as $d) { ?>
                                                                <div class="panel panel-info">
                                                                    ...
                                                                    <div class="panel-footer">
                                                                        <center>
                                                                            <h4 style="font-size:15px;font-weight:700;font-weight:700;"><a href='laporan.php'>Tabel Laporan <i class='fa fa-angle-double-right'></i></a></h4>
                                                                        </center>
                                                                    </div>
                                                                </div>
                                                            <?php
