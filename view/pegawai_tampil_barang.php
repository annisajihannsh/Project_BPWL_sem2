                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <div class="d-flex">
                                                    <div class="p-2 bg-light flex-fill"><a href="../view/pegawai_edit_barang.php?id=<?php echo $d['id']; ?>&aksi=edit"><button class="btn btn-warning btn-sm">Edit</button></a></div>
                                                    <div class="p-2 bg-light flex-fill"><a href="../controller/pegawai_proses_barang.php?id=<?php echo $d['id']; ?>&aksi=hapus"><button class="btn btn-danger btn-sm">Hapus</button></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php
