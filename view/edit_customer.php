        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div>
                            <a style="text-align:center;" href="../view/tampil_customer.php"><button type="button" class="btn btn-primary btn-md pull-right" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            <form action="../controller/proses_customer.php?aksi=update" method="post">
                                <?php foreach ($db->edit($_GET['kode_customer']) as $data) { ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="kode_customer" class="form-control" required="" value="<?php echo $data['kode_customer'] ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Nama Customer</td>
                                            ...
                                            <tr>
                                                <td>Usia Customer</td>
                                                <td><input type="number" name="usia_customer" class="form-control" value="<?php echo $data['usia_customer'] ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Alamat Customer</td>
                                                <td><input type="text" name="alamat_customer" class="form-control" value="<?php echo $data['alamat_customer'] ?>"></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>
