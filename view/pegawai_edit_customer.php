        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div>
                            <a style="text-align:center;" href="../view/pegawai_tampil_customer.php"><button type="button" class="btn btn-primary btn-md pull-right" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            <form action="../controller/pegawai_proses_customer.php?aksi=update" method="post">
