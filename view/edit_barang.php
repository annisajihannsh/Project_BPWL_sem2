        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div>
                            <a style="text-align:center;" href="../view/tampil_barang.php"><button type="button" class="btn btn-primary btn-md pull-right" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            <form action="../controller/proses_barang.php?aksi=update" method="post">
