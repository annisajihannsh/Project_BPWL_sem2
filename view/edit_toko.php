                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            <form action="../controller/proses_toko.php?aksi=update" method="post">
                                <?php foreach ($db->edit($_GET['id_toko']) as $data) { ?>
                                    <table class="table table-striped bordered">
                                        <tbody>
                                            <tr>
                                                <td>Kode Produk</td>
                                                <td>
                                                    <input type="text" name="id_toko" value="<?php echo $data['id_toko'] ?>" required="" required="required" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Nama Toko</td>
                                                <td>
                                                    <input type="text" name="nama_toko" class="form-control" value="<?php echo $data['nama_toko'] ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Alamat</td>
                                                <td>
                                                    <input type="text" name="alamat_toko" class="form-control" value="<?php echo $data['alamat_toko'] ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Telepon</td>
