<?php
require_once '../model/database_transaksi.php';
require_once '../view/header.php';

if (!isset($_GET['id_order'])) {
    header('Location: ../view/laporan.php');
}
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card mb-4">
                            <div>
                                <a style="text-align:center;" href="../view/laporan.php"><button type="button" class="btn btn-primary btn-md pull-left" data-toggle="modal" data-target="#myModal">
                            ...
                            <div class="container mt-5">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $query = mysqli_query($conn, "SELECT * FROM `detail_order` INNER JOIN produk ON detail_order.id_produk = produk.id WHERE id_order = '$_GET[id_order]'");
                                        $no = 1;
