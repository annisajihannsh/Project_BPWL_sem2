        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div>
                            <a style="text-align:center;" href="../view/tampil_user.php"><button type="button" class="btn btn-primary btn-md pull-right" data-toggle="modal" data-target="#myModal">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="container">
                            <form action="../controller/proses_user.php?aksi=update" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" name="id" class="form-control" required="" value="<?php echo $data['id'] ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Nama</td>
                                            ...
                                            <tr>
                                                <td>Password</td>
                                                <td><input type="password" name="password" class="form-control" value="<?php echo $data['password'] ?>"></td>
                                            </tr>
                                            <tr>
                                                <td>Status</td>
                                                <td>
...
<body>
    ...
    <form action="../controler/proses_user.php?aksi=update" method="post">
        <?php foreach ($db->edit($_GET['id']) as $data) { ?>
