<?php
include '../model/database_income.php';
$db = new database();
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($db->tampil_income() as $d) {
                                    ?>
                                        <tr>
                                            <td style="text-align:center;"><?php echo $no++; ?></td>
                                            <td style="text-align:center;"><?php echo $d['tahun']; ?></td>
                                            <td style="text-align:center;"><?php echo $d['bulan']; ?></td>
                                            <td style="text-align:right;"><?php echo $d['total_pendapatan']; ?></td>
