<?php
include '../model/database_customer.php';
$db = new database();
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-row-reverse">
                                <a style="text-align:center;" href="../view/input_customer.php"><button type="button" class="btn btn-primary btn-md pull-left" data-toggle="modal" data-target="#myModal">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <div class="d-flex">
                                                    <div class="p-2 bg-light flex-fill"><a href="../view/edit_customer.php?kode_customer=<?php echo $d['kode_customer']; ?>&aksi=edit"><button class="btn btn-warning btn-sm">Edit</button></a></div>
                                                    <div class="p-2 bg-light flex-fill"><a href="../controller/proses_customer.php?kode_customer=<?php echo $d['kode_customer']; ?>&aksi=hapus"><button class="btn btn-danger btn-sm">Hapus</button></a></div>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php
                        ...
                        <dialog open>
                            ...
                            ?>
                            <form method="post" action="../controller/proses_customer.php?aksi=tambah">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="tampil_customer.php"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></a>
                                                    </div>
                                                </tr>
                                            </tbody>
                                        </table>
